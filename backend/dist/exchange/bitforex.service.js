...
exports.BitforexService = void 0;
const common_1 = require("@nestjs/common");
const logger_service_1 = require("../logger/logger.service");
let BitforexService = class BitforexService {
    constructor(logger) {
        this.logger = logger;
        this.simulationMode = true;
        this.baseUrl = 'https://api.bitforex.com';
...
exports.BitforexService = BitforexService;
exports.BitforexService = BitforexService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_service_1.LoggerService])
], BitforexService);
//# sourceMappingURL=bitforex.service.js.map