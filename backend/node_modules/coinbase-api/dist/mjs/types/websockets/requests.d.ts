 ...
 */
export type WsExchangeAuthenticatedRequestOperation<TWSTopic extends string = string> = WsExchangeRequestOperation<TWSTopic> & {
    signature: string;
    key: string;
    passphrase: string;
    timestamp: string;
 ...
 */
export interface WsInternationalRequestOperation<TWSTopic extends string = string> {
 ...
 */
export type WsInternationalAuthenticatedRequestOperation<TWSTopic extends string = string> = WsInternationalRequestOperation<TWSTopic> & {
    time: string;
    key: string;
    passphrase: string;
    signature: string;
 ...
 */
export type WsPrimeAuthenticatedRequestOperation<TWSTopic extends string = string> = WsPrimeRequestOperation<TWSTopic> & {
    access_key: string;
    api_key_id: string;
    passphrase: string;
    signature: string;
