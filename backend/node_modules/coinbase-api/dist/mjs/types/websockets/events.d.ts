...
export interface CBAdvancedTradeErrorEvent {
    type: 'error';
    message: string;
    wsKey: typeof WS_KEY_MAP.advTradeMarketData | typeof WS_KEY_MAP.advTradeUserData;
}
/**
...
export interface CBExchangeBaseEvent {
    ...
    wsKey: typeof WS_KEY_MAP.exchangeMarketData | typeof WS_KEY_MAP.exchangeDirectMarketData;
}
/**
