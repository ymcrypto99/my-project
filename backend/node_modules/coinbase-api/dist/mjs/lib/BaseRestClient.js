...
import { APIIDPrefix, getRestBaseUrl, logInvalidOrderId, REST_CLIENT_TYPE_ENUM, serializeParams, } from './requestUtils.js';
    ...
    async signRequest(data, url, endpoint, method, signMethod) {
        ...
        if (signMethod === 'coinbase') {
            ...
            const signRequestParams = method === 'GET' || method === 'DELETE'
                ? serializeParams(data?.query || data, strictParamValidation, encodeQueryStringValues, '?', explodeArrayParameters)
                : requestBodyString;
            ...
            switch (clientType) {
                ...
                default: {
                    console.error(new Date(), neverGuard(clientType, `Unhandled sign client type : "${clientType}"`));
